...
export const gameEvents: GameEvent[] = [
  ...
  },
  {
    ...
    type: "market",
    description:
      "坊市一处丹药摊前熙攘，你看见几位商人正出售各种丹药和功法。",
    choices: [
      {
        id: "A",
        label: "购买凝神丹",
        description: "提升心境与修炼稳定性。",
        resultText: "你买下凝神丹，心境大幅提升，突破更顺畅。",
        effect: { mood: 10, spiritStones: -12, cultivationMethod: "凝神诀" },
        extraHistory: "在坊市购得凝神丹，心境舒缓。",
      },
      {
        id: "B",
        label: "讨论功法",
        description: "与商贩交谈，寻找适合自己的法门。",
        resultText: "你获得了一本残破玉简，上面记载着基本心法。",
        effect: { inventory: ["残破玉简"], comprehension: 3, mood: 4 },
        extraHistory: "在坊市获得残破玉简，心法有所启发。",
      },
      {
        id: "C",
        label: "警惕骗局",
        description: "避免上当，宁可错过。",
        resultText: "你识破了商人的骗局，保存住灵石与心境。",
        effect: { mood: 6, spiritStones: 5 },
        extraHistory: "在坊市保持冷静，避免被骗。",
      },
    ],
  },
  {
    ...
    type: "secretRealm",
    description:
      "秘境入口隐现虚空光芒，传说其中藏有上古法宝和珍稀丹药。",
    choices: [
      {
        id: "A",
        label: "深入探索",
        description: "冒险闯入，争取最大的回报。",
        resultText: "你在秘境中找到残破玉简与延寿丹，收获颇丰。",
        effect: { inventory: ["残破玉简", "延寿丹"], cultivationExp: 25, mood: 6 },
        triggerCombat: true,
        combatScene: "secretRealm",
        extraHistory: "深入秘境，获得珍稀法宝与丹药。",
      },
      {
        id: "B",
        label: "谨慎搜寻",
        description: "稳扎稳打，避免危险。",
        resultText: "你搜集到一枚护心丹，并避开了秘境中的陷阱。",
        effect: { inventory: ["护心丹"], mood: 8, lifespan: -1 },
        extraHistory: "在秘境中谨慎行事，获得护心丹。",
      },
      {
        id: "C",
        label: "暂且退回",
        description: "先探查再决定，避免鲁莽行动。",
        resultText: "你退回入口，保存了寿元，但也错过了一些机缘。",
        effect: { mood: 5, lifespan: -1 },
        extraHistory: "暂退秘境，保全了当前局面。",
      },
    ],
  },
];
